    ...
    <div className="space-y-16">
      ...
      <section className="space-y-6">
        <div className="flex items-center justify-center gap-6 md:justify-start">
          <Image src="/hadassah.png" alt="Hadassah" width={70} height={70} className="h-14 w-auto object-contain" priority />
          <Image src="/HUJI.png" alt="Hebrew University of Jerusalem" width={120} height={70} className="h-14 w-auto object-contain" priority />
        </div>
        ...
        <div className="flex flex-col items-center gap-3 sm:flex-row sm:justify-center md:justify-start">
          <Link href="/research" className="inline-flex items-center justify-center rounded-md bg-[#4B2E6A] px-6 py-2 text-base font-medium text-white hover:opacity-90">
            Explore Our Work
          </Link>
          <Link href="/publications" className="inline-flex items-center justify-center rounded-md border border-[#4B2E6A] px-6 py-2 text-base font-medium text-[#4B2E6A] hover:bg-black/5">
            View Publications
          </Link>
        </div>

        <div className="pt-2">
          <h3 className="text-lg font-semibold text-[#4B2E6A]">What we focus on</h3>
