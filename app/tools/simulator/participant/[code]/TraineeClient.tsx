...
// ── Trainee client component — receives code as a plain string from server ────
export default function TraineeClient({ code }: { code: string }) {
  ...
  // Poll DB-backed live state every 2s
  useEffect(() => {
