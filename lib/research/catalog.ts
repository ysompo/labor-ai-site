...
Labor & Delivery (23): mode_start_new (Spontaneous/pitocin/balloon/prostaglandin/combined), mode_of_end (NVD/IVD/UCD/ECD), anesth_type_cat (no_anesth/epidural/spinal/general), Bishop_Score (0-13), Meconium (clear/meconium1/meconium2/meconium3/bloody), maternal_contraction (binary), full_dilation_time, first_stage_length, second_stage_length, third_stage_length, prolonged_second_stage (binary), cd_during_second_stage (binary), time_ROM_delivery, CS_urgency (Urgent/Elective), CS_uterine_cut, obstetrical_bleeding (binary), tear_or_episiotomy (binary), degree_of_tear_or_episiotomy (0-4), admission, birth_year (2015-2024), birth_month (1-12)
